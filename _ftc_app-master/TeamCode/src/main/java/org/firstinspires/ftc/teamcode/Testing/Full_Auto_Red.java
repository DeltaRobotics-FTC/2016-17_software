 ...
 */
@Autonomous (name = "Full_Auto_Red", group = "")
public class Full_Auto_Red extends OpModeCamera {
    ...
    public void loop() {
        ...
        switch (state) {
            ...
            case Drive1:
                while(motorL.getCurrentPosition() > motorLCurrentEnc + encA)
                {
                    motorLF.setPower(-.30);
                    motorL.setPower(-.30);
                    motorRF.setPower(.30);
            ...
            case Turn1:
                while(motorL.getCurrentPosition() > motorLCurrentEnc + encB)
                {
                    motorLF.setPower(-.65);
                    motorL.setPower(-.65);
                    motorRF.setPower(-.65);
            ...
            case LongForward:
                while(motorL.getCurrentPosition() > motorLCurrentEnc + encC)
                {
                    motorLF.setPower(-.35);
                    motorL.setPower(-.35);
                    motorRF.setPower(.35);
            ...
            case TurnToWhiteLine:
                while(motorL.getCurrentPosition() > motorLCurrentEnc + encD)
                {
                    motorLF.setPower(-.65);
                    motorL.setPower(-.65);
                    motorRF.setPower(-.65);
            ...
            case ShortForward:
                if (motorL.getCurrentPosition() > motorLCurrentEnc + encE) {
                    motorLF.setPower(-.20);
                    motorL.setPower(-.20);
                    motorRF.setPower(.20);
                    motorR.setPower(.20);
            ...
            case ForwardToBeacon:
                if(distance < .07 && (motorL.getCurrentPosition() > motorLCurrentEnc + encF))
                {
